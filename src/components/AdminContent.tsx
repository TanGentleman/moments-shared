...
/**
 * AdminContent component provides administrative functionality including:
 * - Data management tools for seeding and clearing test data
 * - User management panel for role assignment and user deletion
 * Only accessible to authenticated users via the admin route.
 */
